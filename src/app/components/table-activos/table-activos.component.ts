...
export class TableActivosComponent {
  ...
  @ViewChild(NuevoActivoComponent, { static: false }) nuevoActivoComponent!: NuevoActivoComponent;
...
obtenerActivos(){
  console.log("Token",this.token);
    ...
    fnNuevoActivo(nuevoActivo : boolean){
        this.nuevoActivoComponent.abrirModalNuevoAct(nuevoActivo);
    }
}
